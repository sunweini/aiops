...
```bash
chmod +x ~/.openclaw/workspace-shared/aiops/rag/skills/aiops-query
```
...
1. 读取模板 `~/.openclaw/workspace-shared/aiops/rag/skills/templates/sop.md` — 了解 frontmatter 格式和文档结构
...
1. 读取 `~/.openclaw/workspace-shared/aiops/rag/skills/templates/tech.md`
...
1. 读取 `~/.openclaw/workspace-shared/aiops/rag/skills/templates/incident.md`
